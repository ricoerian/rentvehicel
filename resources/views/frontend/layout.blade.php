      ...
      <header class="site-navbar site-navbar-target" role="banner">
        <div class="container">
          <div class="row align-items-center position-relative">
            <div class="col-3">
              <div class="site-logo">
                <a href="{{ url('/') }}"><strong>SewaKendaraan.id</strong></a>
              </div>
            </div>
            ...
            <div class="col-9 text-right">
              ...
              >
                <ul class="site-menu main-menu js-clone-nav ml-auto">
                  ...
                  <li><a href="{{ url('daftar-kendaraan') }}" class="nav-link">Daftar Kendaraan</a></li>
                  </li>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 mb-4 mb-md-0">
              ...
              <p class="mb-0 opa-7">
                Buruan sewa kendaraan sekarang sebelum harga bbm naik
              </p>
            </div>
            <div class="col-lg-5 text-md-right">
              <a href="/daftar-kendaraan" class="btn btn-primary btn-white">Sewa Sekarang</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-md-12">
              <div class="border-top pt-5">
                <p>
                  ...
                  All rights reserved | <a href="">SewaKendaraan.id</a>
                </p>
              </div>
            </div>
          </div>
